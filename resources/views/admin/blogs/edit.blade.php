<x-layouts.admin title="Edit Blog" header="Edit Blog">
    <div class="space-y-6">
        <!-- Back Button -->
        <div>
        ...
        <!-- Form -->
        <form action="{{ route('admin.blogs.update', $blog) }}" method="POST" enctype="multipart/form-data" class="bg-white rounded-lg border border-gray-200 p-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div>
                ...
                @if($blog->image)
                    <div class="mb-4">
                        <img src="{{ $blog->image }}" alt="Current image" class="max-w-md h-64 object-cover rounded-lg border border-gray-200">
                        <p class="mt-2 text-sm text-gray-600">Current image (upload a new file to replace)</p>
                    </div>
                @endif
                <input 
                    type="file" 
            ...
            <div>
                ...
                <p class="mt-1 text-xs text-gray-500">
                    <span id="excerptCount">{{ strlen(old('excerpt', $blog->excerpt ?? '')) }}</span>/500 characters
                </p>
                @error('excerpt')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                @enderror
