    ...
    <section class="relative py-16 px-6 lg:px-16 overflow-hidden bg-gray-50" data-animate="fade-up" style="opacity: 1; visibility: visible;">
        <div class="max-w-7xl mx-auto">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 mb-16">
                {{-- Address Card --}}
                <div class="contact-card-modern group" data-animate="fade-up" data-delay="0.1">
                    ...
                    <h3 class="contact-card-title" style="font-family: 'Satoshi', sans-serif;">
                        Address
                    </h3>
                    <p class="contact-card-text" style="font-family: 'Satoshi', sans-serif;">
                ...
                {{-- Phone Card --}}
                <div class="contact-card-modern group" data-animate="fade-up" data-delay="0.2">
                    <div class="contact-card-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <a href="tel:+919001090010" class="contact-card-link" style="font-family: 'Satoshi', sans-serif;">
                        +91 9001090010
                    </a>
                </div>

                {{-- Email Card --}}
                <div class="contact-card-modern group" data-animate="fade-up" data-delay="0.3">
                    <div class="contact-card-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <a href="mailto:hello@nesthetix.com" class="contact-card-link" style="font-family: 'Satoshi', sans-serif;">
                        hello@nesthetix.com
                    </a>
                </div>
            </div>
    ...
    <section class="relative py-16 px-6 lg:px-16 overflow-hidden bg-white" data-animate="fade-up" style="opacity: 1; visibility: visible;">
        <div class="max-w-7xl mx-auto">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div class="contact-form-modern" data-animate="fade-up" style="opacity: 1; visibility: visible;">
                    <div class="mb-8">
                        ...
                        <p class="text-gray-600 leading-relaxed" style="font-family: 'Satoshi', sans-serif;">
                            Fill out the form below and we'll get back to you within 24 hours. We're here to help bring your vision to life.
                        </p>
                    </div>
                    ...
                    <form class="space-y-6" method="POST" action="#">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="form-group-modern">
                                <label for="email" class="form-label-modern" style="font-family: 'Satoshi', sans-serif;">
                                    Email Address *
                                </label>
                                <input 
                                    type="email" 
                            ...
                            <div class="form-group-modern">
                                <label for="phone" class="form-label-modern" style="font-family: 'Satoshi', sans-serif;">
                                    Phone Number
                                </label>
                                <input 
                                    type="tel" 
                ...
                {{-- Map Section --}}
                <div class="contact-map-modern" data-animate="fade-up" data-delay="0.2" style="opacity: 1; visibility: visible;">
                    <div class="mb-8">
                        <h2 
                            class="font-light text-3xl md:text-4xl text-theme-primary leading-tight mb-4"
                            style="font-family: 'Canela Text Trial', serif; letter-spacing: -0.02em;"
                        ...
                        <p class="text-gray-600 leading-relaxed mb-6" style="font-family: 'Satoshi', sans-serif;">
                            We're located in the heart of Bangalore. Feel free to visit us during business hours or schedule an appointment.
                        </p>
                        <div class="bg-gray-50 rounded-lg p-6 mb-6">
                            <div class="space-y-4">
                                <div class="flex items-center gap-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-[var(--color-primary)]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                                    <div>
                                        <p class="font-semibold text-gray-900 text-sm" style="font-family: 'Satoshi', sans-serif;">Business Hours</p>
                                        <p class="text-gray-600 text-sm" style="font-family: 'Satoshi', sans-serif;">Mon - Sat: 9:00 AM - 6:00 PM</p>
                                    </div>
                                </div>
                                <div class="flex items-center gap-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 text-[var(--color-primary)]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <div>
                                        <p class="font-semibold text-gray-900 text-sm" style="font-family: 'Satoshi', sans-serif;">Location</p>
                                        <p class="text-gray-600 text-sm" style="font-family: 'Satoshi', sans-serif;">The Hulkul, Lavelle Road, Bengaluru</p>
                                    </div>
                                </div>
                            </div>
                        </div>
