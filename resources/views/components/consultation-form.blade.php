...
<div id="consultationLightbox" class="consultation-lightbox fixed inset-0 z-[9999] hidden">
    ...
    <div class="lightbox-container absolute inset-0 flex items-center justify-center p-4">
        ...
        <div class="lightbox-content relative w-full max-w-md bg-white rounded-xl shadow-2xl">
            {{-- Close Button --}}
            <button type="button"
                class="absolute -top-2 -right-2 z-10 w-8 h-8 flex items-center justify-center rounded-full bg-white shadow-lg hover:bg-gray-100 transition-colors"
                data-consultation-close aria-label="Close">
            ...
            <form id="consultationForm" class="p-5 space-y-3" method="POST" action="#">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <div>
                        ...
                        <input type="text" id="consultation_name" name="name" required placeholder="Your name"
                    ...
                    <div>
                        ...
                        <input type="tel" id="consultation_phone" name="phone" required placeholder="Your phone"
                            class="consultation-input w-full px-3 py-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:border-transparent transition-all text-gray-700 placeholder-gray-300" />
                    </div>
                </div>
                ...
                <div>
                    ...
                    <input type="email" id="consultation_email" name="email" required placeholder="your@email.com"
                        class="consultation-input w-full px-3 py-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:border-transparent transition-all text-gray-700 placeholder-gray-300" />
                </div>
                ...
                <div>
                    ...
                    <textarea id="consultation_message" name="message" rows="2"
                        placeholder="Tell us about your project..."
                        class="consultation-input w-full px-3 py-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:border-transparent transition-all text-gray-700 placeholder-gray-300 resize-none"></textarea>
                </div>
            ...
            <div id="consultationSuccess" class="hidden p-8 text-center">
                ...
                <button type="button" class="px-5 py-2 rounded-lg text-sm font-medium text-white"
                    style="background-color: var(--color-primary);" data-consultation-close>
                    Close
                </button>
            </div>
        </div>
