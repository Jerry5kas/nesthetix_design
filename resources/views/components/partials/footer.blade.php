<!-- Footer -->
<footer class="public-footer py-16 relative overflow-hidden" style="background-color: var(--color-primary);">
        {{-- Pattern Background Overlay --}}
        <div class="absolute inset-0 pointer-events-none mix-blend-screen" style="background-image: url('{{ asset('images/pattern/pattern-6.png') }}'); background-size: cover; background-position: center; opacity: 0.3;"></div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="#" class="footer-link text-sm">Web Design</a></li>
                        <li><a href="#" class="footer-link text-sm">Branding</a></li>
                        <li><a href="#" class="footer-link text-sm">UI/UX Design</a></li>
                        <li><a href="#" class="footer-link text-sm">Development</a></li>
                        <li><a href="#" class="footer-link text-sm">Digital Marketing</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-4">
                        <li>
                            <a href="mailto:hello@nesthetix.com" class="flex items-start gap-3 footer-link text-sm">
                        ...
                        <li>
                            <a href="tel:+1234567890" class="flex items-start gap-3 footer-link text-sm">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <li>
                            <div class="flex items-start gap-3 text-white/60 text-sm">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
                                </svg>
                                <span>123 Design Street<br>Creative City, ST 12345</span>
                            </div>
                        </li>
                    </ul>
                </div>
            ...
            <div class="pt-8 border-t border-white/10">
                <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                    <p class="text-white/50 text-sm">
                        &copy; {{ date('Y') }} {{ $theme['settings']['site_name'] ?? 'Nesthetix' }}. All rights reserved.
                    </p>
                    <div class="flex items-center gap-6">
                        <a href="#" class="footer-link text-sm">Privacy Policy</a>
                        <a href="#" class="footer-link text-sm">Terms of Service</a>
                        <a href="#" class="footer-link text-sm">Cookie Policy</a>
                    </div>
                </div>
            </div>
        </div>
